...
and predicts dipoles and quadrupoles. The dipole prediction uses a contribution from atomic dipoles.

The dipole moment is expressed as: 

$$
\begin{aligned}
\mu = \sum_{i}{}^{3}\mathbb{P}_{i} + q_{i} \cdot \mathbf{r}_{i}
...
@export_model
def AC_AD_dipole_quadrupole_model(features, labels, mode, params):
